...
const INITIAL_PATIENT_INVOICES: PatientInvoice[] = [
  ...
  },
  {
    ...
    patientName: 'Patient',
    mrn: 'MC-1005',
    email: 'patient.account@medflow.com',
    phone: '+91 98765 xxxxx',
    department: 'Cardiology & Respiratory Medicine',
    attendingDoctor: 'Dr. Anup Singh',
    lineItems: [
      { id: 'li-15', description: 'Pulmonary & Respiratory OPD Consultation', category: 'CONSULTATION', qty: 1, unitPrice: 1800, amount: 1800, tpaCovered: true },
      { id: 'li-16', description: 'Digital Chest X-Ray (PA View) Diagnostic Scan', category: 'LAB_TEST', qty: 1, unitPrice: 1450, amount: 1450, tpaCovered: true },
      { id: 'li-17', description: 'CBC & CRP Inflammatory Biomarkers Panel', category: 'LAB_TEST', qty: 1, unitPrice: 1200, amount: 1200, tpaCovered: true },
      { id: 'li-18', description: 'Respiratory Prescriptions (Azithromycin, Levosalbutamol Inhaler)', category: 'PHARMACY', qty: 1, unitPrice: 850, amount: 850, tpaCovered: false },
    ],
    subtotal: 5300,
    gstRatePercent: 5,
    gstAmount: 265,
  ...
  {
    id: 'inv-106',
    invoiceCode: 'INV-2026-9906',
    date: '2026-05-14',
    timestamp: new Date('2026-05-14').getTime(),
    patientName: 'Patient',
    mrn: 'MC-1005',
    email: 'patient.account@medflow.com',
    phone: '+91 98765 xxxxx',
    ...
    lineItems: [
      { id: 'li-19', description: 'Annual Executive Health Audit & Consultation', category: 'CONSULTATION', qty: 1, unitPrice: 2200, amount: 2200, tpaCovered: false },
      { id: 'li-20', description: 'Comprehensive Metabolic & Serum Lipid Profile', category: 'LAB_TEST', qty: 1, unitPrice: 1850, amount: 1850, tpaCovered: false },
    ],
    subtotal: 4050,
    gstRatePercent: 5,
    gstAmount: 202.5,
    ...
    tpaStatus: 'Direct Patient Payment',
    tpaApprovedAmount: 0,
    netPatientPayable: 4252.5,
    paymentStatus: 'PAID',
    paymentMethod: 'Credit Card (Visa ending in 8812)',
  },
];
