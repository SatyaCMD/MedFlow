...
function VerifyPageContent() {
  ...
  return (
    <div className="min-h-screen flex bg-slate-50 text-slate-800 font-sans overflow-hidden">
      ...
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-start py-6 px-4 sm:px-8 relative bg-slate-50 overflow-y-auto">
        ...
        <motion.div
          ...
          className="w-full max-w-md bg-white border border-slate-200/90 rounded-3xl p-6 sm:p-8 shadow-xl relative z-10 space-y-4 my-2"
        >
          <button
