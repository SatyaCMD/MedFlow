...
export const StatCard: React.FC<StatCardProps> = ({
  ...
  return (
    <motion.div
      ...
      className="p-6 bg-white border border-slate-100 rounded-2xl relative overflow-hidden flex flex-col justify-between shadow-sm"
    >
      <div className="flex items-center justify-between">
        <span className="text-xs font-bold uppercase tracking-wider text-slate-400">{title}</span>
        {Icon && (
          <div className="p-2 bg-blue-50 border border-blue-100/50 text-blue-600 rounded-xl">
      ...
      <div className="mt-4 flex flex-col gap-1">
        <h2 className="text-3xl font-bold tracking-tight text-slate-800 tabular-nums">{value}</h2>
